...
require (
	// Xray-core v25.10.15 (released 2025-10-15)
	// Using v1.251015.0 tag which is Go module compatible
	// Release: https://github.com/XTLS/Xray-core/releases/tag/v25.10.15
	// Commit: b69a376
...
require (
	...
	// Wintun project is stable and rarely updated
